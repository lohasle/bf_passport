package com.sz.weizy.passport.utils.ucenterapi;
...
/*	static {
	...
	public static Client getInstance(String ucApi,String ucIp,String ucKey,String ucAppId,String ucConnect){
		UC_API = ucApi;
		UC_IP = ucIp;
		UC_KEY = ucKey;
		UC_APPID = ucAppId;
...
//		}
	...
	public String uc_api_input(String $data) {
		...
		String $s = urlencode(uc_authcode($data+"&agent="+md5("")+"&time="+time(), "ENCODE"            , UC_KEY),"utf-8");
		return $s;
	}
...
//		}
	...
	protected String uc_fopen(String $url, int $limit, String $post, String $cookie, boolean $bysocket ,String $ip , int $timeout , boolean $block ) {
		...
		if($post!=null && $post.length()>0) {
			...
			$out.append("Content-Type: application/x-www-form-urlencoded;charset=utf-8\r\n");
	 ...
	 * @return
	 */
	public String uc_user_synrename(String uid,String oldusername,String newusername){
		Map<String, Object> args = new HashMap<String, Object>();
		args.put("uid",uid);
		args.put("oldusername",oldusername);
		args.put("newusername",newusername);
		return uc_api_post("user", "rename", args);
	}
	 ...
	 * @return
	 */
	public String uc_user_synrepwd(String username,String oldpwd,String newpwd){
		return uc_user_edit(username,oldpwd,newpwd,null,1,null,null);
	}
	 ...
	 * @return
	 */
	public String uc_user_synforgetPwd(String username,String password){
		Client e = new Client();
		Map<String, Object> args = new HashMap<String, Object>();
		args.put("username",username);
		args.put("password",password);
		String str = e.uc_api_post("user","updatepw",args);
		return str;
	}
}
